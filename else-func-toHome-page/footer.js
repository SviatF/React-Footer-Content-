    ...
    <div style={styles.ft}>
            <div style={styles.ftHead}>
                 ...
                 <div style={styles.flxbc}>
                     ...
                     <a href="#" style={styles.fticonst}><i class="fab fa-telegram"></i></a>
                     <a href="#" style={styles.fticonst}><i class="fab fa-instagram"></i></a>
                     <a href="#" style={styles.fticonst}><i class="fab fa-pinterest"></i></a>
                     <a href="#" style={styles.fticonst}><i class="fa-brands fa-facebook"></i></a>
